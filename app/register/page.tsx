    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex items-center justify-center p-4 relative font-sans">
      ...
      <Card className="max-w-md w-full border border-slate-200 rounded-3xl p-4 shadow-sm bg-white relative z-10">
        <CardHeader className="text-center space-y-2">
          ...
          <CardTitle className="text-xl font-black text-slate-900 tracking-tight">Đăng Ký Tài Khoản</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="space-y-1.5">
              <Label htmlFor="fullName" className="text-xs font-bold text-slate-600">Họ và Tên</Label>
              <Input
                id="fullName"
                type="text"
